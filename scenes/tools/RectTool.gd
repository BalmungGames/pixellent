...
var filled: bool = false  # toggled externally (e.g. holding Shift), see Canvas.gd
...
func _redraw_preview(pos: Vector2i) -> void:
	...
	_apply_symmetric(start_pos, pos, Callable(self, "_do_rect"))
	_refresh()

func _do_rect(p0: Vector2i, p1: Vector2i) -> void:
	var img := Global.get_current_layer().image
	PixelOps.draw_rect(img, p0.x, p0.y, p1.x, p1.y, Global.primary_color, filled)
